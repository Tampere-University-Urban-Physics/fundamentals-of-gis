...
This can also include our choice of how we classify our data. The image below shows the same data on poverty in the USA, classified by equal intervals, natural breaks, and quantiles (you may recognise these from playing around with symbologies). The different classifications lead to different conclusions being drawn from the map. Likewise, the number of classifications we use can also lead to different nuances in maps.
